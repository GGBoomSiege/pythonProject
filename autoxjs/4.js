...
function douyinPoints() {
  ...
  var douyin_points_flag = images.read("./douyin/douyin_points_flag.png");
  var douyin_points_flag_point = waitForImage(douyin_points_flag, 3000);
  douyin_points_flag.recycle();

  if (douyin_points_flag_point) {
    click(douyin_points_flag_point.x, douyin_points_flag_point.y);
    sleep(3000);
  }
...
function douyinCash() {
  ...
  var pre_douyin_cash_flag = images.read("./douyin/pre_douyin_cash_flag.png");
  var pre_douyin_cash_flag_point = waitForImage(pre_douyin_cash_flag, 3000);
  pre_douyin_cash_flag.recycle();

  if (pre_douyin_cash_flag_point) {
    var douyin_cash_flag = images.read("./kuaishou/douyin_cash_flag.png");
    var douyin_cash_flag_point = waitForRegionImage(douyin_cash_flag, pre_douyin_cash_flag_point.x, pre_douyin_cash_flag_point.y, 970, 148, 3000);
    douyin_cash_flag.recycle();

    if (douyin_cash_flag_point) {
      click(douyin_cash_flag_point.x, douyin_cash_flag_point.y);
    }
  }
}
